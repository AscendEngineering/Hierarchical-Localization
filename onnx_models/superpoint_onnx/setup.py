#!/usr/bin/env python3
"""
Download SuperPoint ONNX model.
"""
...
MODEL_URL = "https://github.com/fabio-sim/LightGlue-ONNX/releases/download/v1.0.0/superpoint.onnx"
...
def setup(force: bool = False) -> bool:
    """Download and verify SuperPoint model."""
    print("\n[SuperPoint ONNX]")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Setup SuperPoint ONNX model")
